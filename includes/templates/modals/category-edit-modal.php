...
<div id="categoryEditModal" class="modal-backdrop hidden fixed inset-0 flex items-center justify-center z-50" role="dialog" aria-modal="true" aria-labelledby="categoryEditModalTitle" data-dialog-dismiss="categoryEditCancel" data-dialog-backdrop-dismiss="false">
    <div class="modal-panel p-6 w-full max-w-md mx-4">
        ...
        <form id="categoryEditForm" class="dialog-form space-y-4">
            ...
            <div>
                <label for="category-edit-collapsed-link-limit" class="block text-sm font-medium text-gray-700 mb-1">Links shown when collapsed</label>
                <input type="number" id="category-edit-collapsed-link-limit" min="1" max="20" step="1" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>
            <div>
